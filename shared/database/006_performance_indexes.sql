-- Add missing tenant_id indexes to optimize multi-tenant query performance
-- Resolves catastrophic full table scans for frequently queried tables
-- (Identified missing indexes based on tables containing tenant_id but lacking explicit CREATE INDEX)
